...
目前整体功能已经趋于完善，但我的代码能力还有限，可能还有优化空间。
另外，由于英文水平不足，没办法直接在主分支提交贡献，还请大家多多包涵。
如果你们在使用中发现问题或有更好的想法，欢迎提出意见或帮助改进，一起让 ENT 更加完善。


## Welcome everyone to pull my updates!

**I’ve made fairly comprehensive improvements and extensions to ENT！**
**including:**

**External vehicle XML**

**External ped XML**

**Global font control**

**Fully adjustable menu coordinates**

**Improved built-in hotkeys**

**Most key remapping functions**

The overall functionality is now quite complete, though my coding ability is still limited and there may be room for further optimization.
Also, due to my limited English skills, I’m not able to contribute directly to the main branch — I hope you can understand.
If you find any issues or have better ideas while using it, please feel free to share your feedback or help improve it together.
